...
// Handles complex mathematical operations locally without always needing to query the backend

export const evaluateMathExpression = (expr: string): string => {
  try {
...
export const isMathProblem = (input: string): boolean => {
...
export const solveMathProblem = (input: string): string | null => {
